...
function Header() {
  return (
    <header className="fixed top-5 left-1/2 transform -translate-x-1/2 bg-white/10 backdrop-blur-md rounded-full w-[90vw] md:w-[50vw] h-[5vh] z-50 flex justify-center items-center shadow-lg">
